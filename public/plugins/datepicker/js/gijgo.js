...
gj.grid.plugins.inlineEditing.config = {
    base: {
        ...
        inlineEditing: {
             ...
             *     });
             * </script>
             * @example DateTime <!-- datepicker, grid -->
             * <table id="grid"></table>
             * <script>
             *     var grid, data = [
...
gj.datetimepicker.config = {
    base: {
         ...
         * @additionalinfo All configuration options that exists on the datepicker level are going to override the options at datepicker level.
         * @type object
         * @default undefined
         * @example Sample <!-- datepicker -->
         * <input id="datepicker" width="312" />
         ...
         * </script>
         * @example MaterialDesign.Modal <!-- datepicker -->
         * <input id="datepicker" width="312" />
         * <script>
         *    $('#datepicker').datepicker({ uiLibrary: 'materialdesign', modal: true, footer: true });
         * </script>
         * @example Bootstrap.3 <!-- bootstrap, datepicker -->
         * <input id="datepicker" width="220" />
         * <script>
         ...
         * <input id="datepicker" width="234" />
         * <script>
         *     $('#datepicker').datepicker({ uiLibrary: 'bootstrap4', modal: true, footer: true });
         * </script>
         */
        uiLibrary: 'materialdesign',
         ...
         * <script>
         *    $('#datepicker').datepicker({ value: '22:10 03/27/2018' });
         * </script>
         * @example HTML <!-- datepicker -->
         * <input id="datepicker" width="300" value="22:10 03/27/2018" />
         * <script>
         *     $('#datepicker').datepicker();
         * </script>
         */
         ...
         * <script>
         *     $('#input').datepicker({ format: 'HH:MM yyyy-dd-mm' });
         * </script>
         * @example Long.Month.Format <!-- datepicker -->
         * <input id="input" value="10 October 2017 05:50" width="312" />
         * <script>
         *     $('#input').datepicker({ format: 'dd mmmm yyyy HH:MM' });
         * </script>
         */
         ...
         * <input id="input" width="312" />
         * <script>
         *    $('#input').datepicker({ modal: true });
         * </script>
         * @example Bootstrap <!-- bootstrap, datepicker -->
         * <input id="input" width="220" />
         * <script>
         *    $('#input').datepicker({ uiLibrary: 'bootstrap', modal: true, footer: true });
         * </script>
         * @example Bootstrap.4 <!-- bootstrap4, datepicker -->
         * <input id="input" width="234" />
         * <script>
         *    $('#input').datepicker({ uiLibrary: 'bootstrap4', modal: true, footer: true });
         * </script>
         */
        modal: false,
         ...
         * <input id="input" width="312" />
         * <script>
         *    $('#input').datepicker({ footer: true, modal: true, header: true });
         * </script>
         * @example False <!-- datepicker -->
         * <input id="input" width="312" />
         * <script>
         *    $('#input').datepicker({ footer: false });
         * </script>
         */
        footer: false,
         ...
         * <script>
         *     $('#small').datepicker({ uiLibrary: 'bootstrap4', size: 'small' });
         *     $('#default').datepicker({ uiLibrary: 'bootstrap4', size: 'default' });
         *     $('#large').datepicker({ uiLibrary: 'bootstrap4', size: 'large' });
         * </script>
         * @example Bootstrap.4.Font.Awesome <!-- bootstrap4, fontawesome, datepicker -->
         * <p><label for="small">Small Size:</label> <input id="small" width="234" value="10:20 03/20/2018" /></p>
         * <p><label for="default">Default Size:</label> <input id="default" width="234" value="10:20 03/20/2018" /></p>
         * <p><label for="large">Large Size:</label> <input id="large" width="234" value="10:20 03/20/2018" /></p>
         * <script>
         *     $('#small').datepicker({ uiLibrary: 'bootstrap4', iconsLibrary: 'fontawesome', size: 'small' });
         *     $('#default').datepicker({ uiLibrary: 'bootstrap4', iconsLibrary: 'fontawesome', size: 'default' });
         *     $('#large').datepicker({ uiLibrary: 'bootstrap4', iconsLibrary: 'fontawesome', size: 'large' });
         * </script>
         * @example Bootstrap.3 <!-- bootstrap, datepicker -->
         ...
         * <script>
         *     $('#small').datepicker({ uiLibrary: 'bootstrap', size: 'small' });
         *     $('#default').datepicker({ uiLibrary: 'bootstrap', size: 'default' });
         *     $('#large').datepicker({ uiLibrary: 'bootstrap', size: 'large' });
         * </script>
         * @example Material.Design <!-- datepicker -->
         ...
         *     $('#default').datepicker({ size: 'default' });
...
gj.datetimepicker.methods = {
    ...
    destroy: function ($datetimepicker) {
        ...
        if (data) {
            ...
            $datetimepicker.removeAttr('data-type').removeAttr('data-guid').removeAttr('data-datepicker');
...
gj.datetimepicker.events = {
    /**
     * Fires when the datepicker value changes as a result of selecting a new value.
     *
     * @event change
     * @param {object} e - event data
     * @example sample <!-- datepicker -->
...
gj.datetimepicker.widget = function ($element, jsConfig) {
     ...
     * <button class="gj-button-md" onclick="alert($datepicker.value())">Get Value</button>
     * <hr/>
     * <input id="datepicker" width="312" value="17:50 03/27/2018" />
     * <script>
     *     var $datepicker = $('#datepicker').datepicker();
     * </script>
     * @example Set <!-- datepicker -->
     * <button class="gj-button-md" onclick="$datepicker.value('13:40 08/01/2017')">Set Value</button>
     * <hr/>
     * <input id="datepicker" width="312" />
     * <script>
     *     var $datepicker = $('#datepicker').datepicker();
