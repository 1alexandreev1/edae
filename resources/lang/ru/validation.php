...
return [
    ...
    */
    'attributes' => [
        ...
        'document_header'        => 'Наличие шапки в документе',
        'organization_details'     => 'Использовать реквизиты организации',
        'counterparty_details'     => 'Использовать реквизиты контрагента',
        'margin_left'             => 'Отступ слева в пикселях',
        'margin_right'             => 'Отступ справа в пикселях',
        'counterparty_id'         => 'Контрагент',
        'cap_image'                => 'Шапка изображением',
        'header_text'            => 'Шапка документа текстом',
        'header_image'            => 'Изображение для шапки',
        'number'                => 'Номер',
        'montage_service_id'       => 'Монтаж',
        'printing_service_id'      => 'Типография',
    ],
];
